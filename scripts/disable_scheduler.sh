...
aws scheduler update-schedule --name $schedule_name --cli-input-json "$schedule_json" --state DISABLED --flexible-time-window "$flexible_time_window" --schedule-expression "$schedule_expression" --target "$target"
